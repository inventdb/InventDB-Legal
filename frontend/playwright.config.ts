...
/**
 * End-to-end tests for InventDB Legal — both halves.
 *
 ...
 * otherwise.
 */
// Matches vite.config.ts. Not 5173: a sibling InventDB app on the default port
// would otherwise be reused by `reuseExistingServer` and quietly tested instead
// of this one.
