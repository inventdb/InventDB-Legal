  ...
  async function run() {
    ...
    try {
      const next = await designer.mutateAsync({
        ...
        // caption bold" builds on what is on screen instead of starting over.
  ...
  return (
    <div className="view-designer" data-testid="view-designer">
      <div className="vd-head">
        ...
        <p className="vd-lede">
          {existing
            ? `Describe a change to “${existing.name}” — “group them by practice area”, “show the balance bigger”, “add the responsible attorney”. The change is applied to this view.`
      ...
      >
        <input
          ...
          placeholder={
            amending
              ? "Describe a change — e.g. “make the balance bold”"
              : `e.g. “a card per record with the caption, a status badge and the balance”`
          }
