 ...
 *
 * SOAR's SQL generator is a dedicated `/ai/generate-sql` route; this app reaches
        ...
        {mode === "describe" ? (
          <div className="we-pane">
            <p className="we-sub">
              ...
              its open matters, unbilled value and count of deadlines due, as a compact
              scorecard”.
            </p>
            {history.length > 0 && (
          ...
          <div className="we-pane">
            ...
            <div className="we-row we-ask">
              <AutoTextarea
                className="input"
                placeholder="✦ Describe the query — e.g. “top matters by unbilled time”"
                value={ask}
                onChange={setAsk}
