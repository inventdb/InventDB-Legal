...
/** The namespace every record lives in. Pinned server-side; named here only
 *  because the widgets' SQL has to qualify its tables. */
export const NS = "legal";
 ...
 * about the docket" — so the layout serves a question rather than the whole
 * database.
 */
