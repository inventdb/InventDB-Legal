...
export const STEP_KINDS: StepKind[] = [
  ...
  },
  {
    ...
    sideEffecting: true,
    fields: [
      { name: "to", label: "To", type: "text", required: true, placeholder: "${clients.email}", hint: TEMPLATED },
  ...
  },
  {
    ...
    blurb: "Writes a new row — a deadline, a time entry, a trust ledger line.",
    icon: PlusCircle,
    sideEffecting: true,
    fields: [
      { name: "namespace", label: "Namespace", type: "text", required: true, placeholder: "legal" },
      { name: "type_name", label: "Type", type: "text", required: true, placeholder: "deadlines_and_sol" },
  ...
  },
  {
    ...
    fields: [
      { name: "namespace", label: "Namespace", type: "text", required: true, placeholder: "legal" },
      { name: "type_name", label: "Type", type: "text", required: true, placeholder: "invoices" },
      {
        name: "record_id",
        label: "Record id",
        type: "text",
        required: true,
        placeholder: "${due_soon.first._id}",
...
/** The types a record-change trigger can watch. */
const ENTITY_TYPES = ENTITIES.map((e) => e.name);
  ...
  },
  {
    ...
    specFields: [
      ...
      },
      {
        ...
        required: true,
        defaultValue: "legal",
        hint: "Where your practice data lives. Change this only if you know you need to.",
      },
    ],
  },
  {
