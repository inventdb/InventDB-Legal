...
const NAV: NavGroup[] = [
  ...
  {
    section: "Practice",
    items: ["matters", "clients", "timekeepers"].map(entityEntry),
  },
  {
    section: "Time & Billing",
    items: ["time_entries", "costs_and_disbursements", "invoices"].map(entityEntry),
  },
  {
    section: "Money",
    items: ["payments_and_receipts", "trust_ledger_cta", "settlements_and_liens"].map(
      entityEntry
    ),
  },
  {
    section: "Calendar & Docket",
    items: ["court_calendar", "deadlines_and_sol"].map(entityEntry),
  },
  {
    section: "Intake",
    items: ["intake_and_leads", "lookups"].map(entityEntry),
  },
  {
...
function pageTitle(pathname: string): string {
  ...
  return ENTITY_BY_NAME[seg]?.labelPlural ?? "InventDB Legal";
}
