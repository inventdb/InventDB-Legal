...
const STARTERS = [
  "Which deadlines are open in the next 30 days, and who owns them?",
  "Unbilled billable time by matter, biggest first",
  "Costs advanced by expense category this year",
  "Which invoices are more than 90 days outstanding?",
];
    ...
    <div className="content an-room">
      <div className="page-head">
        <div className="titles">
          <h2>Analyze</h2>
          <p>
            Ask about your practice in plain language. The assistant answers from
        ...
        <form className="an-composer" onSubmit={(e) => void submitAsk(e)}>
          ...
          <div className="an-composer-foot">
            ...
            <button
              ...
              title="Also search inside your documents by meaning — pleadings, retainers, scanned exhibits — not just structured fields."
            >
