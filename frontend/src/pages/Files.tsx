/**
 * Files — every document in the practice, in one place.
 *
 * InventDB keeps files as attachments on records: the scanned retainer belongs
 * to a client, the filed complaint to a matter. That is good for provenance
 ...
 * namespace the signed-in user can see: this one is pinned to the Legal
...
export default function Files() {
   ...
   * `?type=matters&folder=2026` opens the tree to that folder too — arriving at
    ...
    <div className="content">
      <div className="page-head">
        <div className="titles">
          <h2>Files</h2>
          <p>
            Every document in the practice, wherever it is attached — pleadings, retainers,
