/**
 * Import — InventDB SOAR's spreadsheet importer, in the Legal app.
 *
 * This is a port of SOAR's `rooms/store/RichImport.tsx`, not an app-specific
 ...
 * tables.
 *
 * Columns are keyed, not mapped. `keyify("Matter ID")` is `matter_id`,
 * which is already the field name this app's forms and tables use — so a workbook
 ...
 * record lives in the one namespace, pinned server-side, exactly as the Files
 * room pins it.
 */
