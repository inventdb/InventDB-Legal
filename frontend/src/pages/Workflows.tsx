/**
 * Workflows — the automations that run against this practice, and the
...
export default function Workflows() {
   ...
   * certain: which of these is the automation my practice is relying on?
   *
    ...
    <div className="content">
      <div className="page-head">
        <div className="titles">
          <h2>Workflows</h2>
          <p>
            Automations that run against your practice — scheduled reports, alerts and data
