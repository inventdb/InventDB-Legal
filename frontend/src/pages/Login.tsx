...
const FEATURES = [
  "Matters, clients and the whole file in one place",
  "Time, costs, billing and trust accounting that reconcile",
  "A docket that shows what is due before it is late",
      ...
      <div className="login-hero">
        <div className="hero-copy">
          ...
          <div className="login-story">
            <h1>Legal practice, modernised.</h1>
            <p>
              A single, fast workspace for a firm to run every matter it holds
