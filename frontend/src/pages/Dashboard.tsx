/**
 * Dashboard — InventDB SOAR's Today room, in the Legal app.
 *
 ...
 * dashboard is stored per user rather than per user per namespace, because this
 * app has one namespace; and the assistant's token usage is not shown.
 */
...
function Head() {
  return (
    <div className="room-head">
      <div className="room-kicker">Today · Legal</div>
