 ...
 * the spec verbatim; this app draws every other chart with Recharts in the brand
 ...
 * series, axis titles and stacking are honoured, and colours come from the app
