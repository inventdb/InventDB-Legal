 ...
 *
 * When the rows all belong to one module and aren't group summaries, each
 * row opens that record in its module (`/matters?focus=<id>`). A joined or
...
export function DataGrid({
  ...
  // Only rows from one module can be opened — the module page is the only
