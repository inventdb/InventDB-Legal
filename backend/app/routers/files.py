...
belongs to `legal.matters/mt-1`, the signed retainer to `legal.clients/cl-2`.
...
rather than an omission: a Legal user asking for files should never be able to
...
def attach_file():
    ...
    the question a legal assistant actually asks: *which matter is this?* This
    ...
    belongs to two records, an order resolving two motions.
    """
    body = _body()
