...
Legal modules. That is deliberate and matches SOAR: a workbook written to this
schema keyifies its sheet names straight onto the module types (``Time Entries``
-> ``time_entries``), and one that isn't still imports rather than being refused.
