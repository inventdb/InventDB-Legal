...
class InventDBClient:
    ...
    # record — `legal.matters/mt-1` owns its scanned pleadings — and exposes a
    ...
    def relink_attachment(
        ...
        records (one order resolving two motions).
        """
        ns = _safe_ident(self.namespace, "namespace")
        return self._request(
            "POST",
    ...
    # app-specific — InventDB owns the agent, its tools and its RBAC; this app
    ...
    # an edit or delete made in this app lands there too.
