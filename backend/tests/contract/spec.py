...
DASHBOARD_CHARTS = {
    "cashflow": [CASHFLOW_POINT],
    "matter_status": [NAME_VALUE],
    "practice_area": [NAME_VALUE],
    "deadline_status": [NAME_VALUE],
    "deadline_priority": [NAME_VALUE],
    "cost_breakdown": [NAME_VALUE],
    "ar_aging": [NAME_VALUE],
}
...
PNL = {
    ...
    "costs_total": "number",
    "realization": "number",
    "billed_by_practice": [NAME_VALUE],
    "costs_by_category": [NAME_VALUE],
}

CASHFLOW = {"cashflow": [CASHFLOW_POINT]}
...
CASELOAD = {
    ...
    "by_practice_area": [NAME_VALUE],
    "by_responsible_attorney": [NAME_VALUE],
    "total": "int",
    "open": "int",
    "open_rate": "number",
}
...
TIME_ENTRIES_REPORT = {
    "by_task": [NAME_VALUE],
    "by_activity": [NAME_VALUE],
    "by_timekeeper": [NAME_VALUE],
    "unbilled_value": "number",
}

AR_AGING = {
    "buckets": [{"name": "string", "invoices": "int", "value": "number"}],
    "by_status": [NAME_VALUE],
...
TRUST_COMPLIANCE = {
    ...
    "amount_out": "number",
    "trust_balance": "number",
    "negative_ledgers": [RECORD],
    "negative_count": "int",
    "by_transaction_type": [NAME_VALUE],
}
...
# pinning it here would break this app every time a new step kind was added.
...
FILE_SEARCH = {
    ...
    "folders": [
        {
            "namespace?": "string",
            # A folder always belongs to a type: "2026" under invoices and "2026"
            # under court_calendar are different folders, and the tree groups by
...
ENDPOINTS: list[dict[str, Any]] = [
    ...
    },
    {
        "key": "matters-search",
        "method": "GET",
        "path": "/api/matters?q=a&limit=5",
        "shape": _list_of(RECORD),
    },
    {
        "key": "matter-detail",
        "method": "GET",
        "path": "/api/matters/{record_id}",
        "shape": RECORD,
    },
    {
        "key": "matter-create",
        "method": "POST",
        "path": "/api/matters",
        "body": {"matter_caption": "Pineda v. Bright Path", "client_name": "Pineda, Carmen", "status": "Open"},
        "shape": RECORD,
        "status": 201,
    },
    {
        ...
        "method": "PUT",
        "path": "/api/matters/{record_id}",
        "body": {"client_name": "Pineda, Carmen R."},
        "shape": RECORD,
    },
    {
        "key": "matter-delete",
    ...
    {"key": "report-wip", "method": "GET", "path": "/api/reports/wip", "shape": WIP},
    {
        "key": "report-deadlines",
        "method": "GET",
        "path": "/api/reports/deadlines",
        "shape": DEADLINES,
    },
    {
        "key": "report-caseload",
        "method": "GET",
        "path": "/api/reports/caseload",
        "shape": CASELOAD,
    },
    {
        "key": "report-time-entries",
        "method": "GET",
        "path": "/api/reports/time-entries",
        "shape": TIME_ENTRIES_REPORT,
    },
    {
        "key": "report-ar-aging",
        "method": "GET",
    ...
    {
        "key": "report-trust-compliance",
        "method": "GET",
        "path": "/api/reports/trust-compliance",
        "shape": TRUST_COMPLIANCE,
    },
    ...
    },
    {
        ...
        "body": {"type": "invoices", "folder": "2026", "limit": 15},
    ...
    },
    {
        ...
        "body": {"attachment_id": "att-001", "type": "invoices", "record_id": "lea-001"},
        "shape": FILE_ATTACH,
    },
    {
        "key": "workflow-detail",
