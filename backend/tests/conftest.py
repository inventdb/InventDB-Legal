...
os.environ["LEGAL_STATE_FILE"] = str(
    Path(tempfile.gettempdir()) / "legal-test-settings-do-not-create.json"
)
...
@pytest.fixture
def rows():
    """Small row factory: ``rows(3, client_name="Mumbai")`` -> three numbered records."""
